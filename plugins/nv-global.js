...
this.sendFile(m.chat, stiker, 'sticker.webp', null, m, false, { contextInfo: { externalAdReply: { title: '𝚈𝚘?', body: ':v', sourceUrl: `wa.me/+51946460695`, thumbnail: imagen1}}})}
...
//Audios agregados 04/07/2023//

if (!chat.isBanned && chat.audios && m.text.match(/(Wazaaa|wazaaa)/gi)) {
let vn= './media/audiowazaaa.mp3'
this.sendPresenceUpdate('recording',m.chat)
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt:true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Feliz Jueves|feliz jueves|Feliz jueves)/gi)) {
let vn= './media/jueves.mp3'
this.sendPresenceUpdate('recording',m.chat)
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt:true})}
    
if (!chat.isBanned && chat.audios && m.text.match(/(Jajaja|jajaja|JAJAJA)/gi)) {
let vn= './media/jajaja.mp3'
this.sendPresenceUpdate('recording',m.chat)
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt:true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Cinema|Es cine|CINEMA)/gi)) {
let vn= './media/cinema.mp3'
this.sendPresenceUpdate('recording',m.chat)
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt:true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Que bendición|que bendicion|que bendición)/gi)) {
let vn= './media/Bendición.mp3'
this.sendPresenceUpdate('recording',m.chat)
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt:true})}
